...
class SnS_Global_Page
{
	...
	function admin_enqueue_scripts() {
		...
		wp_enqueue_script( 'sns-global-page-scripts', plugins_url('js/global-page.js', Scripts_n_Styles::$file), array( 'jquery', 'codemirror-css', 'codemirror-javascript', 'less.js' ), Scripts_n_Styles::VERSION, true );
		wp_localize_script( 'sns-global-page-scripts', '_SnS_options', $localize );
		
		wp_enqueue_script( 'less.js', plugins_url( 'libraries/less/dist/less-1.1.6.min.js', Scripts_n_Styles::$file), array(), '1.1.6' );
